...
const Gallery = () => {
  return (
    <section id="gallery" className="py-10  mx-auto">
          ...
          <div className="flex gap-3">
            {data?.Gallery
              ...
              .map((blog) => (
                <div
                  key={blog.id}
                  className="flex-shrink-0 w-48 h-48 rounded-lg overflow-hidden bg-gray-200 border-gray-300 shadow-4xl"
                >
                  <img
                    src={blog.image}
                    alt={blog.title}
